...
class feature_fuse(nn.Module):
    def __init__(self, in_c, out_c):
        ...
        self.conv11 = nn.Conv3d(
            in_c, out_c, kernel_size=1, padding=0, bias=True)
        self.conv33 = nn.Conv3d(
            in_c, out_c, kernel_size=3, padding=1, bias=True)
        self.conv33_di = nn.Conv3d(
            in_c, out_c, kernel_size=3, padding=2, bias=True, dilation=2)
...
class FR_UNet(SegmentationNetwork):
    def __init__(self,  num_classes=1, num_channels=1, feature_scale=4,  dropout=0., fuse=True, out_ave=True):
        ...
        # self.fuse = nn.Conv3d(5, num_classes, kernel_size=1, padding=0, bias=True)
