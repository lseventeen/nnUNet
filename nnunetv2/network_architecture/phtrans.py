...
class PHTrans(SegmentationNetwork):
    def __init__(self, img_size, base_num_features, num_classes, image_channels=1, only_conv=True,num_only_conv_stage=2, num_conv_per_stage=2,num_transformer_per_stage = 2,
