...
def convert_CIAS(dataset_path,task_id):
    ...
    training_images_path = join(dataset_path, "training","images")
    training_labels_path = join(dataset_path, "training", "labels")
    test_images_path = join(dataset_path, "test","images")
    test_labels_path = join(dataset_path, "test", "labels")


    image_files = subfiles(training_images_path, join=False, suffix='nii.gz')
...
if __name__ == "__main__":
    ...
    parser.add_argument("-dataset_path", type=str,
                        default='/ai/data/data/vessel/DIAS/DSA/data/training')
